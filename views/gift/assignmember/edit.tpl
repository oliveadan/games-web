	...
	<div class="layui-body">
	    ...
	    <div class="layui-tab layui-tab-brief">
	        <ul class="layui-tab-title">
	            ...
	            <li class="layui-this">编辑内定会员</li>
	        </ul>
	        <div class="layui-tab-content">
	            <div class="layui-tab-item layui-show">
	                <form class="layui-form form-container" action='{{urlfor "AssignMemberEditController.post"}}' method="post">
	                    {{ .xsrfdata }}
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
								<select id="giftId" name="GiftId" lay-verify="required" lay-search>
									<option value=""></option>
	                               	{{range $i, $m := .giftList}}
									<option value="{{$m.Id}}" {{if eq $m.Id $.data.GiftId}}selected="selected"{{end}}>编号：{{$m.Seq}}  名称：{{$m.Name}}</option>
									{{end}}
	                            </select>
							</div>
	                    </div>
