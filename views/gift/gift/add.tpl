	...
	<div class="layui-body">
	    ...
	    <div class="layui-tab layui-tab-brief">
	        <ul class="layui-tab-title">
	            ...
	            <li class="layui-this">添加奖品</li>
	        </ul>
	        <div class="layui-tab-content">
	            <div class="layui-tab-item layui-show">
	                <form class="layui-form form-container" action='{{urlfor "GiftAddController.post"}}' method="post">
	                    {{ .xsrfdata }}
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
								<input type="number" name="Seq" value="" required lay-verify="required" placeholder="请输入编号，必须为数字1-1000000" class="layui-input">
							</div>
	                    </div>
	                    <div class="layui-form-item">
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
								<input type="text" name="Probability" value="" required lay-verify="required" placeholder="请输入中奖概率，必须为数字0-1000000(百万)" class="layui-input">
							</div>
	                    </div>
	                    <div class="layui-form-item">
	                        <label class="layui-form-label">数量</label>
	                        <div class="layui-input-block">
								<input type="text" name="Quantity" value="" required lay-verify="required" placeholder="请输入数量，必须为数字0-1000000" class="layui-input">
							</div>
	                    </div>
	                    <div class="layui-form-item">
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-inline" style="width: 60px;">
								<input type="checkbox" name="BroadcastFlag" value="1" lay-skin="switch" lay-text="开启|开启">
							</div>
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
								<input type="text" name="Content" value="" placeholder="请输入奖品内容，金额或其他" class="layui-input">
							</div>
	                    </div>
                        <div class="layui-form-item">
