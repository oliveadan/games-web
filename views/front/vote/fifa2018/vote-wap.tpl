...
<div class="header">
		<div class="fl">
			<a href='{{urlfor "Fifa2018ApiController.Get"}}'>世界杯首页</a><a href="http://www.fifa.com/worldcup/" target="_blank">俄罗斯官网</a>
...
<div class="container">
	...
	<div class="form-div">
		...
		<div class="vote-share">分享获得更多投票机会！<button type="button" class="share-btn">点击分享</button></div>
