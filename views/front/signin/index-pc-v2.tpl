...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/signin/v2/css/style.css"/>
    <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/signin/v2/css/responsive.css"/>
</head>
<body>
<div id="wrap" class="clearfix">
    <div id="wrapper-header">
        ...
        <div class="notice">
            <div class="marquee-box">
                <marquee direction="left" id="view_annouVal" scrollamount="2" onmouseover="this.stop()" onmouseout="this.start()">
                {{.announcement}}
                </marquee>
            </div>
        </div>
    ...
    <div class="content event" id="contentEventDiv">
        ...
        <div class="eventMain">
            <div class="headd" >
                <img src="{{static_front}}/static/front/signin/v2/images/top12.png">
            </div>
            <div class="rankingSection" >
                <div {{if eq .gameStatus  2}} style="display:none"{{end}} class="wrapper-feature-title" id="rankingImgTitle"><img id="imgTitle-1" src="{{static_front}}/static/front/signin/v2/images/top10.png">
                </div>
                        ...
                        <table id="eventRankingTable">
                            ...
                            {{if lt $i 3}}
                                <td class="ranking enlarge"><img id="rankingMedal"
                                                                 src="{{static_front}}/static/front/signin/v2/images/no{{numberAdd $i 1}}.png"/>
                                </td>
                ...
                <div class="rankingButtonBar">
                    {{if eq .gameStatus 2}}
                    <div class="rankinginput1" style="background-image: url({{static_front}}/static/front/signin/v2/images/name.png);">
                    ...
                    <div class="rankinginput">
                        ...
                        <div class="rankingBtn1">
                            {{if eq .gameStatus 2}}
                                <img  onclick="carveup({{.gameId}})" src="{{static_front}}/static/front/signin/v2/images/signinguafen.png"
                                      style="cursor: pointer;">
                            {{else}}
                                <img id="rankDay1Btn" src="{{static_front}}/static/front/signin/v2/images/signin.png"
                                     style="cursor: pointer;">
                            {{end}}
                                <a href="{{.officialRegist}}" >
                                    <img id="rankDay1Btn" src="{{static_front}}/static/front/signin/v2/images/registered.png"
                                         style="cursor: pointer;">
                                </a>
                        </div>
                    </div>
                    ...
                    <div class="wrapper-event" id="wrapper-rule">
                        <div class="wrapper-rule-col-2">
                            <div class="wrapper-rule-broder" id="rulePanel">
                                <img class="ruleTitleImg" src="{{static_front}}/static/front/signin/v2/images/tx_rules.png"/>
                            {{str2html .gameRule}}
                            </div>
                        </div>
                    </div>
