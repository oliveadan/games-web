                ...
                <div id="eventRanking">
                    ...
                    <div class="rankingButtonBar">
                        <div class="rankinginput">
                            ...
                            <div class="rankingBtn4">
                                    <img  id="rankDay4Btn" src="{{static_front}}/static/front/signin/v5/images/huoli.png">
                            </div>
                            <div class="rankingBtn2">
                                <a href="javascript:void(0);" class="rl_search">
                                    <img  src="{{static_front}}/static/front/signin/v5/images/signinchaxun.png">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        $("#rankDay4Btn").click(function () {
            ...
            $.ajax({
                ...
                success: function (obj) {
                        console.log(obj);
                        var html = '';
                        var register = '活跃度可免费兑换幸运免单抽奖次数'+"<br><a style=color:red href='/luckyfree'>点击免费抽奖</a>";
