...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/signin/v1/css/style.css"/>
    <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/signin/v1/css/responsive.css"/>
</head>
<body>
<div id="wrap" class="clearfix">
    ...
    <div class="content event" id="contentEventDiv">
        <div id="eventBanner">
            <img id="eventImg" {{if eq .gameStatus 2}}src="{{static_front}}/static/front/signin/v1/images/guafen.jpg"{{else}} src="{{static_front}}/static/front/signin/v1/images/topbg.jpg"{{end}}/>
        </div>
        ...
        <div class="eventMain">
            ...
            <div class="rankingSection" >
                ...
                <div {{if eq .gameStatus  2}} style="display:none"{{end}} class="wrapper-feature-title" id="rankingImgTitle"><img id="imgTitle-1"
                                                                             src="{{static_front}}/static/front/signin/v1/images/top10.png">
                </div>
                        ...
                        <table id="eventRankingTable">
                            ...
                            {{if lt $i 3}}
                                <td class="ranking enlarge"><img id="rankingMedal"
                                                                 src="{{static_front}}/static/front/signin/v1/images/no{{numberAdd $i 1}}.png"/>
                                </td>
                ...
                <div class="rankingButtonBar">
                    <div class="rankinginput">
                        ...
                        <div class="rankingBtn1">
                            {{if eq .gameStatus 2}}
                                <img  onclick="carveup({{.gameId}})" src="/static/front/signin/v1/images/signinguafen.png"
                                      style="cursor: pointer;">
                            {{else}}
                                <img id="rankDay1Btn" src="/static/front/signin/v1/images/signin.png"
                                     style="cursor: pointer;">
                            {{end}}
                        </div>
                    </div>
                    ...
                    <div class="wrapper-event" id="wrapper-rule">
                        <div class="wrapper-rule-col-2">
                            <div class="wrapper-rule-broder" id="rulePanel">
                                <img class="ruleTitleImg" src="/static/front/signin/v1/images/tx_rules.png"/>
                            {{str2html .gameRule}}
                            </div>
                        </div>
                    </div>
            ...
            <div class="eventTxtContainer">
                <div class="eventTxt" id="eventTxt">
                    <img class="ruleTitleImg" src="/static/front/signin/v1/images/tx_resp.png"/>
            ...
            $.ajax({
                ...
                success: function (obj) {
                    if (obj.code == 0) {
                        ...
                        html = html
                                + '<div>今日获得<span style="color:red;">&nbsp;' + obj.data.per + '&nbsp;' + obj.data.unit + '</span></div>'
                                + '<div>当前持有<span style="color:red;">总' + obj.data.unit + '&nbsp;' + obj.data.force + '</span></div>'
                                + '<div>当前等级为<span style="color:red;">&nbsp;' + obj.data.levelName + '</span></div>';
