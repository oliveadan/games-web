...
<html lang="zh-cn">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/quest/css/theme.css">
		<style>
		.error {
			color:red;
		}
                ...
                <div class="survey_wrap">
                    <div class="survey_main">
                        ...
                        <div class="survey_content">
							...
							<form class="questForm" id="questForm" action='{{urlfor "QuestApiController.Post"}}' method="post">
                            {{ .xsrfdata }}
							...
							<div class="survey_container">
								...
								{{range $i, $v := .questList}}
									...
									<div class="question question_radio {{if eq $v.Required 1}}required{{end}}" id="question_{{$v.Id}}" style="display: block;">
                                        <div class="inner">
                                            <div class="title">
                                                <div role="presetation">
                                                    <span class="title_index">
                                                        <span class="question_index">{{$v.Seq}}</span>、</span>
                                                    <h3 class="title_text">
                                                        <p>{{$v.Content}}</p>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="inputs">
                                                ...
                                                <div class="option_item" style="width: 100%;">
                                                    <input class="survey_form_checkbox" type="radio" name="option-{{$v2.Pid}}" id="{{$v2.Id}}" value="{{$v2.Id}}" {{if eq $v.Required 1}}required title="必选"{{end}} />
                                                    <label for="{{$v2.Id}}">
