...
<head>
    ...
    <script type="text/javascript" src="{{static_front}}/static/front/red/wap/js/respond.min.js"></script>
    <link rel="stylesheet" href="{{static_front}}/static/front/red/css/reset.css">
    <link rel="stylesheet" href="{{static_front}}/static/front/red/wap/css/style.css">
</head>
<body>
