...
<link href="{{static_front}}/static/front/red/v3/css/reset.css" rel="stylesheet" type="text/css" />
<link href="{{static_front}}/static/front/red/v3/css/style.css" rel="stylesheet" type="text/css" />
	<style>
        .snowfall-flakes {
            cursor: pointer;
        }
...
<div class="banner">
	<div class="bannercon w1000">
        ...
        <div class="qiang">
            <input type="text" name="commentNameField" id="username" onBlur="if(this.value == '') this.value = '请输入会员账号';" onFocus="if (this.value == '请输入会员账号') this.value = '';" value="请输入会员账号">
		...
		<div class="con con1">
               ...
               <div class="title">中奖名单</div>
         	   	<div class="winlist">  
                        ...
                        <ul>
						{{range $i, $v := .rlList}}
							<li><span class="spa1">恭喜会员 <em class="fc-red">{{$v.account}}</em></span><span class="spa2">获得红包 <em class="fc-red">{{$v.gift}}</em></span></li>
						{{end}}
						</ul>
                        </div>
...
<div  id="hongbao_open" class="popup flip" style="display:none;">
  <div class="popup-t"> <a href="javascript:;" onclick="close_hongbao()" class="b1"><img src="{{static_front}}/static/front/red/v3/images/x.png"></a>
    <p class="b2"><img src="{{static_front}}/static/front/red/v3/images/tu06.png"></p>
    <p class="b3">{{.siteName}}</p>
    <p class="b4">&nbsp;&nbsp;</p>
    <p class="b5" id="b5">您还有<span id="lotteryNums">0</span>次机会</p>
    <a href="javascript:;" onclick="startGame()" class="b6">拆红包</a> </div>
  <div class="popup-b">{{.siteName}}</div>
</div>
<div id="hongbao_result"  class="reward flip" style="display:none;">
  <div class="reward-t"> <a href="javascript:;" onclick="close_hongbao()" style="text-decoration:none;" class="b1"><img src="{{static_front}}/static/front/red/v3/images/x.png"></a>
    <p class="b2"><img src="{{static_front}}/static/front/red/v3/images/tu08.png"></p>
  </div>
  <div class="reward-b">
    <p class="w1">&nbsp;&nbsp;</p>
        ...
        <div class="gdcon">
            <div class="content">
                <form>
                    ...
                    <input type="button" onclick="startGame(2)" class="hb-button ljlllq fl" value="立即领取" />
                </form>
            </div>
        </div>
