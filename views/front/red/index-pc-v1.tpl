...
<link href="{{static_front}}/static/front/red/v1/css/reset.css" rel="stylesheet" type="text/css" />
<link href="{{static_front}}/static/front/red/v1/css/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div  id="hongbao_open" class="popup flip" style="display:none;">
  <div class="popup-t"> <a href="javascript:;" onclick="close_hongbao()" class="b1"><img src="{{static_front}}/static/front/red/v1/images/x.png"></a>
    <p class="b2"><img src="{{static_front}}/static/front/red/v1/images/tu06.png"></p>
...
<div id="hongbao_result"  class="reward flip" style="display:none;">
  <div class="reward-t"> <a href="javascript:;" onclick="close_hongbao()" style="text-decoration:none;" class="b1"><img src="{{static_front}}/static/front/red/v1/images/x.png"></a>
    <p class="b2"><img src="{{static_front}}/static/front/red/v1/images/tu08.png"></p>
  </div>
  <div class="reward-b">
    <p class="w1">&nbsp;&nbsp;</p>
