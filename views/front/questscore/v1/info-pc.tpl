...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{static_front}}/static/front/questscore/css/page_survey.css">
    <link id="theme_css" rel="stylesheet" type="text/css" href="{{static_front}}/static/front/questscore/css/theme.css">
</head>
...
<div id="container" class="g_container">
    <div class="header">
        <div class="headercon w1000">
            <a class="logo" href='{{urlfor "QuestscoreApiController.Get"}}'></a>
            <div class="menu">
                <ul>
                    <li>
