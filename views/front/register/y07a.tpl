        ...
        <div class="wrapper move">
            <div id="register">
                ...
                {{ .xsrfdata }}
                    ...
                    <div class="vali">
                        <label>QQ</label>
                        <input type="text" name="QqNo" value="" placeholder="请输入QQ号码" class="Required">
                    </div>
                    <div class="vali">
                        <label>微信号</label>
                    ...
                    <div class="vali reqtps">
                        <label>取款密码</label>
                        <input type="password" name="WithdrawPass" value="" placeholder="6-12个字符组成，请务必牢记！" class="Requireds" minlength="6" maxlength="12">
                    </div>
                    <div class="vali">
                        <label>提示问题</label>
