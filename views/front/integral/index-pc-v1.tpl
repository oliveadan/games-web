...
<head>
	...
	<title>{{.siteName}}积分商城-{{.gameDesc}}</title>
	<link rel="shortcut icon" href="{{static_front}}/static/img/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="{{static_front}}/static/front/integral/v1/css/common.css">
</head>
<body>
    <header>
        <div class="head-top">
            <div class="clearfix">
                ...
                <a href="http://www.1516dz.vip/" target="_blank" class="top-a">金管家</a>
        ...
        <div class="container">
            ...
            <div class="box box1">
                <div class="box-top">
                    ...
                    <div class="cnt cnt2">
                        ...
                        <ul>
							{{range $i, $v := .giftList}}
							<li style="background: url({{$v.Photo}}) no-repeat;">
                    ...
                    <div class="cnt cnt3">美东时间每周六为会员积分兑换日，当天24小时均可进行兑换，所有现金券可重复兑换。</div>
                </div>
            ...
            <div class="flow-box">
                ...
                <p class="flow1">
                    ...
                    <span>美东时间每周六为会员积分兑换日，当天24小时均可进行兑换，所有现金券可重复兑换。</span>
                </p>
                <p class="flow2"></p>
            </div>
    ...
    <script src="{{static_front}}/static/front/integral/v1/js/common.min.js"></script>
    <script>
        var bgUrl1 = '{{static_front}}/static/front/integral/v1/images/header-bg1.jpg';
        var bgUrl2 = '{{static_front}}/static/front/integral/v1/images/header-bg2.jpg';
        var logoUrl = '{{static_front}}/static/img/logo240x80.png';
    </script>
    <script src="{{static_front}}/static/front/integral/v1/js/header-data.js"></script>
    <script src="{{static_front}}/static/front/integral/v1/js/header.js"></script>
	<script>
	var _username="";
