...
<link href="/static/front/kingrace/css/reset.css" rel="stylesheet" type="text/css" />
<link href="/static/front/kingrace/css/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
		...
		<div class="con con1">
               ...
               <div class="title">英雄榜</div>
         	   	<div class="winlist">  
                        ...
                        <ul>
						{{range $i, $v := .rlList}}
							<li><span class="spa1">恭喜会员 <em class="fc-red">{{$v.account}}</em></span><span class="spa2">荣获 <em class="fc-red">{{$v.gift}}</em></span></li>
						{{end}}
						</ul>
                        </div>
...
<div  id="hongbao_open" class="popup flip" style="display:none;">
  <div class="popup-t"> <a href="javascript:;" onclick="close_hongbao()" class="b1"><img src="/static/front/kingrace/images/x.png"></a>
    <!-- <p class="b2"><img src="/static/front/kingrace/images/tu06.png"></p>-->
    <!--<p class="b3">{{.siteName}}</p> -->
    <p class="b4">&nbsp;&nbsp;</p>
    <p class="b5" id="b5">您还有<span id="lotteryNums">0</span>次机会</p>
    <a href="javascript:;" onclick="startGame()" class="b6"></a> </div>
  <!-- <div class="popup-b">{{.siteName}}</div>-->
</div>
<div id="hongbao_result"  class="reward flip" style="display:none;">
  <div class="reward-t"> <a href="javascript:;" onclick="close_hongbao()" style="text-decoration:none;" class="b1"><img src="/static/front/kingrace/images/x.png"></a>
    <!--<p class="b2"><img src="/static/front/kingrace/images/tu08.png"></p> -->
  </div>
  <div class="reward-b">
    <p class="w1">&nbsp;&nbsp;</p>
    <p class="w2" style="color: #ffcf2e;">恭喜发财，大吉大利!</p>
    <p class="w3">00.00<em>元</em></p>
    <p class="w4" style="color: yellow">{{.siteName}}</p>
  </div>
</div>
...
<script type="text/javascript" src="/static/front/js/jquery.SuperSlide.2.1.1.js"></script>
