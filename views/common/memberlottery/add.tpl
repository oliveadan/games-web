	...
	<div class="layui-body">
	    ...
	    <div class="layui-tab layui-tab-brief">
	        <ul class="layui-tab-title">
	            ...
	            <li class="layui-this">添加抽奖次数</li>
	        </ul>
	        <div class="layui-tab-content">
	            <div class="layui-tab-item layui-show">
	                <form class="layui-form form-container" action='{{urlfor "MemberLotteryAddController.post"}}' method="post">
	                    {{ .xsrfdata }}
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
								<input type="number" name="LotteryNums" value="" placeholder="请输入抽奖次数，必须是数字" class="layui-input">
							</div>
	                    </div>
	                    <div class="layui-form-item">
	                        <div class="layui-input-block">
