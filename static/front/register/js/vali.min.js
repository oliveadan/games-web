    ...
    my.extend({
        myvali: function (id) {
            var myobj = {
                ...
                myPasswordMaxLength: 16,
                isServer: false,
                corrCol: ["rgb(78, 117, 4)"],
                errCol: ["red"],
                PwdStrong: false,
                isStrongTps: ["弱", "中", "强"],
                isServerType: "post",
                isServerDType: "json",
                count: 60,
                isPhoneCodeType: "post",
                isPhoneCodeDType: "json",
                phoneCodeInputType: "post",
                phoneCodeInputDType: "json",
                phoneIsServerType: "post",
                phoneIsServerDType: "json",
                phoneIsServerType1: "post",
                phoneIsServerDType1: "json",
                CodeIsServerType: "post",
                CodeIsServerDType: "json",
                myPhone: "",
                myPhone1: "",
                myqkmm: "",
                myagree: "",
            ...
            var myVali = $(mclass.myVali), myform = $(mclass.myform), mybtn = $(mclass.mybtn);
            var p = $("<p style=" + "font-size:12px;padding-top:2px;display:inline;" + "></p>");
            myform.find(myVali).append(p);
            var Required = $(mclass.Required), RequiredTps = $(mclass.RequiredTps), Requireds = $(mclass.Requireds),myqkmm = $(mclass.myqkmm),myagree = $(mclass.myagree),
                reqtps = $(mclass.reqtps), Reqlength = $(mclass.Reqlength), ReqlengthTps = $(mclass.ReqlengthTps),
                RequiredsTps = $(mclass.RequiredsTps), myname1 = $(mclass.myName), myname2 = $(mclass.myName2),
                myphone = $(mclass.myPhone), myphone1 = $(mclass.myPhone1), myCard = $(mclass.myCard),
                isPhoneCode = $(Number(mclass.isPhoneCode)), phoneCodeBtn = $(mclass.phoneCodeBtn),
                count = $(mclass.count), codeBtnCol1 = $(mclass.codeBtnCol1), codeBtnCol2 = $(mclass.codeBtnCol2),
                isPhoneCodeUrl = $(mclass.isPhoneCodeUrl), isPhoneCodeType = $(mclass.isPhoneCodeType),
                isPhoneCodeDType = $(mclass.isPhoneCodeDType), phoneCodeInput = $(mclass.phoneCodeInput),
                phoneCodeInputUrl = $(mclass.phoneCodeInputUrl), phoneCodeInputType = $(mclass.phoneCodeInputType),
                phoneCodeInputDType = $(mclass.phoneCodeInputDType), mymailbox = $(mclass.myMailbox),
                mailboxIsServer = $(Number(mclass.mailboxIsServer)), mailboxIsServerUrl = $(mclass.mailboxIsServerUrl),
                mailboxIsServerType = $(mclass.mailboxIsServerType),
                mailboxIsServerDType = $(mclass.mailboxIsServerDType), mypassword = $(mclass.myPassword),
                mypasswords = $(mclass.myConfirmPassword), phoneIsServer = $(Number(mclass.phoneIsServer)),
                phoneIsServerUrl = $(mclass.phoneIsServerUrl), phoneIsServerType = $(mclass.phoneIsServerType),
                phoneIsServerDType = $(mclass.phoneIsServerDType), phoneIsServer1 = $(Number(mclass.phoneIsServer1)),
                phoneIsServerUrl1 = $(mclass.phoneIsServerUrl1), phoneIsServerType1 = $(mclass.phoneIsServerType1),
                phoneIsServerDType1 = $(mclass.phoneIsServerDType1), myCode = $(mclass.myCode),
                CodeIsServerUrl = $(mclass.CodeIsServerUrl), CodeIsServerType = $(mclass.CodeIsServerType),
                CodeIsServerDType = $(mclass.CodeIsServerDType), PwdStrong = $(Number(mclass.PwdStrong)),
                isStrongTps = $(mclass.isStrongTps), NameMinLength = $(mclass.myNameMinLength),
                NameMaxLength = $(mclass.myNameMaxLength), NameMinLength2 = $(mclass.myNameMinLength2),
                NameMaxLength2 = $(mclass.myNameMaxLength2), PasswordMinLength = $(mclass.myPasswordMinLength),
                PasswordMaxLength = $(mclass.myPasswordMaxLength), corrCol = $(mclass.corrCol),
                errCol = $(mclass.errCol), nameIsserver = $(Number(mclass.nameIsserver)),
                nameIsserverUrl = $(mclass.nameIsserverUrl), nameIsServerType = $(mclass.nameIsServerType),
                nameIsServerDType = $(mclass.nameIsServerDType), isMyCode = $(mclass.isMyCode),
                codeval = myform.find(phoneCodeBtn).val();
            var valiform = {
                ismsgbtn: function () {
                    ...
                    var strmyqkmm = /^\d{4}$/;
                    if ($(this).val() == "") {
                        $(this).siblings("p").html("请输入4位数字的取款密码").removeAttr("class").css({"color": errCol[0]})
                    } else if (!strmyqkmm.test($(this).val())) {
                        $(this).siblings("p").html("请输入4位数字的取款密码").removeAttr("class").css({"color": errCol[0]});
                    } else {
                        $(this).siblings("p").html("√").attr({"class": "correct"}).css({"color": corrCol[0]})
                    }
                    ...
                    if (!$(this).attr('checked')) {
                        $(this).siblings("p").html("请确认条款").removeAttr("class").css({"color": errCol[0]})
                    } else {
                        $(this).siblings("p").html("√").attr({"class": "correct"}).css({"color": corrCol[0]})
                    }
                }, pCode: function () {
                    ...
                    var Tsval = $(this).val().replace(/\s/g, '');
                    if (Tsval == "") {
                        $(this).siblings("p").removeAttr("class").css({"color": errCol[0]}).html("请输入中文全名")
                    } else if (Tsval.length < NameMinLength2[0] || Tsval.length > NameMaxLength2[0]) {
                        $(this).siblings("p").html("请输入" + NameMinLength2[0] + "至" + NameMaxLength2[0] + "位字符的中文全名").removeAttr("class").css({"color": errCol[0]})
                    } else {
                        $(this).siblings("p").html("√").attr({"class": "correct"}).css({"color": corrCol[0]})
                    }
                }, Reqd: function () {
                    ...
                    if (Tsval == "") {
                        ...
                        if (Tsval.length >= Reqlength[reqtps.index($(this).parent())][0] && Tsval.length <= Reqlength[reqtps.index($(this).parent())][1]) {
                            ...
                            $(this).siblings("p").removeAttr("class").css({"color": errCol[0]}).html("请输入" + Reqlength[reqtps.index($(this).parent())][0] + "至" + Reqlength[reqtps.index($(this).parent())][1] + "位字符" + ReqlengthTps[reqtps.index($(this).parent())])
                        }
                    } else {
                        $(this).siblings("p").html("√").attr({"class": "correct"}).css({"color": corrCol[0]})
                    }
                    ...
                    var $this = $(this), Tsval = $this.val().replace(/\s/g, "");
                    if (Tsval == "") {
                        $(this).siblings("p").removeAttr("class").css({"color": errCol[0]}).html("请输入验证码");
                        if (isPhoneCode[0] == 1) {
                            if (isMyCode[0] == 1) {
                    ...
                    if (myname2.val() == "") {
                        myname2.siblings("p").removeAttr("class").css({"color": errCol[0]}).html("请输入中文全名")
                    ...
                    if (myqkmm.val() == "") {
                        myqkmm.siblings("p").removeAttr("class").css({"color": errCol[0]}).html("请输入4位数字的取款密码")
                    } else if (myqkmm.siblings("p").html() == "") {
                        valiform.vmyqkmm1.apply(myqkmm)
                    }
                }
            };
            ...
            myqkmm.on("blur keyup", function () {
                valiform.vmyqkmm1.apply($(this))
            });
