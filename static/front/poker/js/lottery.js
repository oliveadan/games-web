...
function checklogin(obj){
	...
	function startGame(obj){	
		...
		_this.removeClass("show").addClass("out");
		$.ajax({
					...
					success: function (obj) {
						...
						case 1:
							...
							var photo = obj.data.photo||"/static/front/poker/images/win.png";
							pokerClick(_this,1,photo);
							break;
						case 2:
							layer.closeAll();
							$(".wintext").html("");
							isClick = false;
							$('#draw').html($('#draw').text()-1);
							var photo = obj.data.photo||"/static/front/poker/images/lose.png";
							pokerClick(_this,2,photo);
							break;
						default:
