...
import (
	"phage-games-web/controllers/common/game"
	"phage-games-web/controllers/common/gameperiod"
	"phage-games-web/controllers/common/member"
	"phage-games-web/controllers/common/memberlottery"
	"phage-games-web/controllers/common/sharedetail"
	"phage-games-web/controllers/front"
	"phage-games-web/controllers/front/bobingapi"
	"phage-games-web/controllers/front/goldeggapi"
	"phage-games-web/controllers/front/guaguaapi"
	"phage-games-web/controllers/front/integralapi"
	"phage-games-web/controllers/front/monthsigninapi"
	"phage-games-web/controllers/front/pokerapi"
	"phage-games-web/controllers/front/questapi"
	"phage-games-web/controllers/front/questscoreapi"
	"phage-games-web/controllers/front/rankingapi"
	"phage-games-web/controllers/front/redapi"
	"phage-games-web/controllers/front/richapi"
	"phage-games-web/controllers/front/signinapi"
	"phage-games-web/controllers/front/tigerapi"
	"phage-games-web/controllers/front/upgradingapi"
	"phage-games-web/controllers/front/vipvalueapi"
	"phage-games-web/controllers/front/voteapi"
	"phage-games-web/controllers/front/weeksignin"
	"phage-games-web/controllers/front/wheelapi"
	"phage-games-web/controllers/front/wishapi"
	"phage-games-web/controllers/gamedetail/integral"
	"phage-games-web/controllers/gamedetail/monthsignin"
	"phage-games-web/controllers/gamedetail/question"
	"phage-games-web/controllers/gamedetail/questionscore"
	"phage-games-web/controllers/gamedetail/ranking/ranking"
	"phage-games-web/controllers/gamedetail/ranking/rankingconfig"
	"phage-games-web/controllers/gamedetail/ranking/rankingdeliver"
	"phage-games-web/controllers/gamedetail/rich"
	"phage-games-web/controllers/gamedetail/signin"
	"phage-games-web/controllers/gamedetail/upgrading"
	"phage-games-web/controllers/gamedetail/vipvalue"
	"phage-games-web/controllers/gamedetail/vote"
	"phage-games-web/controllers/gamedetail/wheel"
	"phage-games-web/controllers/gamedetail/wish"
	"phage-games-web/controllers/gift/assignmember"
	"phage-games-web/controllers/gift/gift"
	"phage-games-web/controllers/rewardlog"
	_ "phage/routers"

	"phage-games-web/controllers/front/boxapi"
	"phage-games-web/controllers/front/kingrace"
	"phage-games-web/controllers/front/luckyfree"
	"phage-games-web/controllers/gamedetail/box"

	"github.com/astaxie/beego"
	"phage-games-web/controllers/common/comment"
	"phage-games-web/controllers/front/sec"
	"phage-games-web/controllers/front/seckill"
	seckillandrush2 "phage-games-web/controllers/gamedetail/seckillandrush"
)
